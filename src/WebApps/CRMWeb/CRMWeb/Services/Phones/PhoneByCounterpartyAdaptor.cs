...
public class PhoneByCounterpartyAdaptor : DataAdaptor
{
    private readonly IPhoneService _phoneService;

    public PhoneByCounterpartyAdaptor()
    {
    ...
    {
        Guid counterpartyId = Guid.Parse(dataManagerRequest.Params["CounterpartyId"].ToString() ?? Guid.Empty.ToString());

        var response = await _phoneService.GetPhonesByCounterparty(counterpartyId);
